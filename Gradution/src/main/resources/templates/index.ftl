...
<ul class="layui-nav" lay-filter="" style="padding:0 36px;text-align: center">
    <#if username?exists>
        <li class="layui-nav-item" style="float: right">
            <span style="color: #0C0C0C" href="javascript:;">欢迎：<strong style="color: #c7254e">${username!}</strong> 用户</span>
        </li>
    <#else>
        <li class="layui-nav-item" style="float: right"><a style="color: #0C0C0C" href="/user/login">用户登录</a></li>
    </#if>
</ul>
            ...
            <div class="layui-container" style="padding: 0px">
                ...
                <div class="layui-row" style="text-align: center">
                  <#list recmomendList as recmomend>
                        ...
                        <a href="/page/id=${recmomend.id}">
                            <div style="padding: 1%" class="layui-col-xs4 layui-col-sm4 layui-col-md4 layui-col-lg4">
                                <img style=" width:80%; height:40vh; max-width:100%; max-height:100%;"
                                     src="/static/back/img/${recmomend.img}"/>
                                <br/>
                    ...
                    <#list nvRecmomend as nvRecmomend>
                        <span>
                        <a href="/page/id=${nvRecmomend.id}">
                            <div style="padding: 1%" class="layui-col-xs4 layui-col-sm4 layui-col-md4 layui-col-lg4">
                                <img style=" width:80%; height:40vh; max-width:100%; max-height:100%;"
                                     src="/static/back/img/${nvRecmomend.img}"/>
                                <br/>
                                <span>${nvRecmomend.title}</span>
        ...
        <div class="layui-colla-content layui-show">
            ...
            <div class="layui-container" style="padding-left: 2px;padding-right: 5px">
                <div class="layui-row"><a href="javascript:moreNewBooks()">
                        <h2 class="layui-colla-title">最近更新小说</h2>
                    </a></div>
                <div class="layui-row" style="padding-top: 10px">
