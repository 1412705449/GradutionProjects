        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="">
                            <a href="javascript:;" _href="authorlist">
                                <cite>作者列表</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    <a class="javascript:;" href="javascript:;">
                        <i class="layui-icon" style="top: 3px;">&#xe613;</i><cite>审核</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="auditStoreAll">
                                <cite>小说审核</cite>
                            </a>
                        </dd>
                        </dd>
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="auditStoreChapAll">
                                <cite>章节审核</cite>
                            </a>
                        </dd>
                        </dd>
