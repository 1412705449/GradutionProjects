...
<body id="read" background="/static/back/img/LoginAuthor.jpg" style=" background-repeat:no-repeat ;background-size:100% 100%;
      ...
      layui.use(['form','layer'], function(){
         ...
         // var $=layui.jquery;
            form.on("submit(login)",function (data) {
              $.post("/author/login",{"bookId":$("#bookIdHidden").val(),"loginName":$("#loginName").val(),"password":$("#password").val()},function (data) {
                  console.log(data);
                 ...
                 if(jsondata.code==200){
                     layer.msg("登录成功",{time:1000},function(data){
                         ...
                         window.location.href="/author/authorTwo";
                     })
